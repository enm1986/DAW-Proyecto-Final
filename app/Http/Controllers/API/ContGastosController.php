...
class ContGastosController extends Controller {
    ...
    public function index($id) {
        $gastos = DB::table('cont_gastos')
                ...
                ->select('cont_gastos.id', 'cont_gastos.concepto', 'cont_gastos.fecha_factura', 'cont_gastos.importe',
                        'cont_gastos.forma_pago', 'cont_gastos.referencia', 'cont_gastos.tipo_gasto', 'cont_gastos.fecha_pago',
                        'cont_gastos.id_cuenta', 'cont_cuentas.banco', 
                        'cont_gastos.id_fondo', 'cont_fondos.nombre as fondo',
                        'cont_gastos.id_proveedor', 'proveedores.nombre as proveedor')
                ->where([
